<div class="printable" dir="rtl">
    <fieldset>
        <legend class="Nassim">
            <strong>
                اطلاعات سفارش<span class="label label-lg label-primary arrowed arrowed-right" style="margin-right: 10px; font-family: BYekan">{{$order->id}}</span>
            </strong>
            @if($order->suspended)
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    <br>
                    {{Form::label('last_edit', 'آخرین ویرایش',['class' => 'control-label Nassim NassimTitle Nassim700'])}}
                    <p class="form-control-static">
                        این سفارش آخرین بار توسط <b>{{$lastEdited->changer->getIdentifier()}}</b> ویرایش شده.
                    </p>
                </div>
            </div>
        </div>
